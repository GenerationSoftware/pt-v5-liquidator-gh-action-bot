...
`JSON_RPC_URL`: By default, this bot uses Optimism mainnet. If you are using a different chain (such as Optimism mainnet) the bot will require a `JSON_RPC_URL` that points to that chain. Make sure this is the full URL and not just an API key.
